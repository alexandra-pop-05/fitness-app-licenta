...
const register = (req, res) => {
    ...
    db.query(q, [req.body.email, req.body.username], (err, data) => {
        ...
        const q = 'INSERT INTO sql_app.users(`username`, `email`, `password`) VALUES(?)';
        const values = [
            req.body.username,
            req.body.email,
            hashedPassword
...
const login = (req, res) => {
    ...
    db.query(q, [req.body.username], (err, data) => {
        ...
        const isPasswordCorrect = bcrypt.compareSync(req.body.password, data[0].password); //data is an array and data[0] is our user
